...
from .views import ClassCreateAPIView, AdminLoginAPIVeiw, CreateSubjectAPIView, NoticeBoardUploadView,TeacherRegisterModelViewSet, StudentRegisterModelViewSet , RoleforTeacherModelView,DirectMessageModelView,TeacherRegistrationModelViewSet
>>>>>>> master
